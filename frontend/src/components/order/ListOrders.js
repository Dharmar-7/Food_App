...
const ListOrders = () => {
    ...
    const setOrders = () => {
        ...
        // Ensure that orders and restaurantList are defined and not empty
        if (orders && orders.length > 0 && restaurantList && restaurantList.length > 0) {
          try {
            ...
            sortedOrders.forEach((order) => {
              ...
              const status = order.orderStatus && String(order.orderStatus).includes("Delivered") ? (
